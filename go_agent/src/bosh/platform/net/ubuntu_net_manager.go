...
func (net ubuntuNetManager) SetupDhcp(networks boshsettings.Networks, errCh chan error) error {
	_, err := net.writeDhcpNetworkInterfaces()
	if err != nil {
...
func (net ubuntuNetManager) writeDhcpNetworkInterfaces() (bool, error) {

	interfaces, err := net.detectNetworkInterfaces()
	if err != nil {
		return false, bosherr.WrapError(err, "Detecting network interfaces")
	}
