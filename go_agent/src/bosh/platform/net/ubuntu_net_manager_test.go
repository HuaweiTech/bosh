...
const expectedUbuntuDhcpNetworkNonInterfaces = `# Generated by bosh-agent
auto lo
iface lo inet loopback
`

const expectedUbuntuDhcpNetworkOneInterfaces = `# Generated by bosh-agent
auto lo
iface lo inet loopback
...
const expectedUbuntuDhcpNetworkTwoInterfaces = `# Generated by bosh-agent
auto lo
iface lo inet loopback
		...
		Context("when dhclient3 is not installed on the system", func() {
			...
			Context("when we have one eth interface on the system", func() {
				...
				It("should have one eth interface on networks", func() {
					_ = netManager.SetupDhcp(networks, nil)
