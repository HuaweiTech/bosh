      ...
      spec.each_pair do |name, network_spec|
        ...
        case network_type
          when "dynamic"
            ...
            cloud_error("At Most only one dynamic network per instance should be defined") if @dynamic_network
            cloud_error("One Network could be defined only once") if @net_ids.include?(net_id)
